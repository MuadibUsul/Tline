...
import { allowedFeishuApprover, loadFeishuSettings, verifyFeishuRequest } from "@/lib/social/feishu";
...
export async function POST(request: NextRequest) {
  ...
  // Feishu URL verification must answer before signature checks, auth and the
  // database, or the console reports "Challenge code没有返回" when saving the URL.

...
export default async function SocialPage({ searchParams }: { searchParams: Promise<{ error?: string; connected?: string }> }) {
  ...
  const feishuConfigured = Boolean(feishu.appId && feishu.appSecret && feishu.receiveId && feishu.approverOpenIds && feishu.encryptKey);
  return <>
